        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgendaName = table.Column<string>(type: "nvarchar(25)", nullable: false),
                    AgendaDate = table.Column<DateTime>(type: "DateTime", nullable: false),
                    LocationStr = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    AgendaDetails = table.Column<string>(type: "nvarchar(25)", nullable: false),
                    Attachment = table.Column<string>(type: "nvarchar(25)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(25)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmpNID = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    PicLoc = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ...
                    EntryBy = table.Column<string>(type: "varchar(20)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnumText = table.Column<string>(type: "varchar(20)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlatConfigs", x => x.FlatNo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FlatNo = table.Column<string>(type: "nvarchar(250)", nullable: false),
                    FlatValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AgendaName = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    PointNo = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    Resolution = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    ResolutionClosingNote = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    ResponsibilityFlatOwner = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    ResponsibilityEmployee = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    StartDate = table.Column<DateTime>(type: "DateTime", nullable: false),
                    DueDate = table.Column<DateTime>(type: "DateTime", nullable: false),
                    Attachment = table.Column<string>(type: "nvarchar(25)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrepairedBy = table.Column<string>(type: "nvarchar(25)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Purpose = table.Column<string>(type: "nvarchar(25)", nullable: false),
                    PaidBy = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Date = table.Column<DateTime>(type: "DateTime", nullable: false),
                    PreparedBy = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    ReceiptNumber = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    FlatNo = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    FlatOwner = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    TransactionStep = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    Claim = table.Column<int>(type: "int", nullable: false),
                    ReceiptFile = table.Column<string>(type: "nvarchar(25)", nullable: true),
                    TransactionCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NextStatus = table.Column<string>(type: "nvarchar(25)", nullable: true),
